...
const run = async () => {
  try {
    const db = client.db("Book_Self");
    const booksCollection = db.collection("All_Books");
    ...
    app.get("/books/recent-added-books", async (req, res) => {
    ...
    app.post("/books/add-new-book", async (req, res) => {
